      ...
      <div className="intro-card">
        ...
        <text className='intro-text'>
          ...
          <p>Hey there, and welcome to my website! I'm a rising junior at Brown University studying Applied Mathematics and Computer Science.
            ...
            addicted as I used to be, I still keep my cubes near my desk if I ever need a break. More recently, I've been getting really into crossword
            puzzles, and I have been solving the NYT crossword everyday since February with a group of friends. A really cool variant of crossword puzzles
            that I recently discovered is cryptic crosswords. Here's an example of a cryptic clue: "really large bird I can stew" (7). The answer is titanic.
            Here's why: titanic means "really large", a tit is a "bird", and anic is "I can" stewed - in other words, the letters in "I can" mixed up.
            Really neat right?
          </p>
        </text>
      </div>
